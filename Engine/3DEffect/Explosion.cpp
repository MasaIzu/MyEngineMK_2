...
void Explosion::PreDraw(ID3D12GraphicsCommandList* cmdList)
{
	// PreDrawとPostDrawがペアで呼ばれていなければエラー
	assert(Explosion::cmdList == nullptr);

	// コマンドリストをセット
	Explosion::cmdList = cmdList;
...
void Explosion::CSUpdate(ID3D12GraphicsCommandList* cmdList,Vector4 StartPos)
{
