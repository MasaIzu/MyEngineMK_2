...
const unsigned short COLLISION_ATTR_INVINCIBLE = 0b110;//無敵

const unsigned short COLLISION_ATTR_ENEMYATTACK = 0b111;//敵の攻撃
const unsigned short COLLISION_ATTR_ENEMYBULLETATTACK = 0b1000;//敵の弾の攻撃

const unsigned short COLLISION_ATTR_CAMERA = 0b1001;//カメラ
